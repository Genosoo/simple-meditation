...
const Meditate = () => {
  ...
  const [isMeditating, setMedidating] = useState(false);
           ...
           <AppGradient colors={['transparent', 'rgba(0, 0, 0, 0.8)']}>
              ...
              <View className='flex-1 justify-center'>
                <View className='mx-auto bg-neutral-200 rounded-full w-44 h-44 justify-center items-center'>
                    <Text className='text-4xl text-gray-800 font-semibold font-rmono'>{formattedTimeMinutes}:{formattedTimeSeconds}</Text>
                </View>
              </View>
